...
{    
     ...
     for(i = 0;i<this.InitBoxNum;i++)
     {
        ...
        var lboxlength = Math.floor(pc.math.random(this.boxminlength,this.boxmaxlength-1));
        ...
        var rlr = false;
        var rboxlength = Math.floor(pc.math.random(this.boxminlength,this.boxmaxlength-1));
